...
st.sidebar.title("Exploritre Data Analyses")
...
for i in features_list:
  st.subheader(f"Scatterplot between {i} and Glasstype")
  plt.figure(figsize=(12,6))
  sns.scatterplot(x = i,y = 'GlassType',data = glass_df)
  st.pyplot()
  st.sidebar.subheader('Histogram')
hist_features = st.sidebar.multiselect('Select the feature to create Histogram ',('RI', 'Na', 'Mg', 'Al', 'Si', 'K', 'Ca', 'Ba', 'Fe'))
...
boxplot_list = st.sidebar.multiselect('Select the Boxplot Value',('RI', 'Na', 'Mg', 'Al', 'Si', 'K', 'Ca', 'Ba', 'Fe'))
# Choosing features for histograms.
for i in boxplot_list:
  st.subheader(f"Boxplot between {i} and Glasstype")
  plt.figure(figsize=(12,6))
